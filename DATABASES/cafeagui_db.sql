...
-- Tiempo de generación: 09-05-2017 a las 11:28:21
...
CREATE TABLE `categoriaxentrada` (
  `ID_CATEGORIAXENTRADA` bigint(20) NOT NULL,
...
(4610, 9, 1, '', '', 'Que es el kumel?', '2016-07-05 04:31:14', '186.83.13.67'),
(4611, 3, 1, 'Yuly pauline González', 'jujupl20@hotmail.com', 'Cordial Saludo\r\nMe gustaría aprender diferentes recetas que hay en preparación frío y caliente en café.\r\nEstoy con la intención de colocar un negocio en la ciudad de Panamá y me gustaría saber con quien puedo hablar para saber más a fondo sobre el café águila roja y que tan fácil es para exportación.\r\nAgradezco su amable atención y colaboración.\r\n\r\nJULY GONZÁLEZ', '2016-07-30 06:44:41', '181.50.225.199'),
(4612, 5, 1, 'Santiago Ruiz Munoz', 'santiago.ruiz.munoz@gmail.com', 'Quisiera saber como puedo obtener el mejor sabor de este tipo de cafe molido, hago la consulta porque soy de Chile y deseo comprar este tipo de cafe, del cual me han contado que es similar a Juan Valdez, saludos', '2016-12-07 23:50:27', '186.34.49.35');
...
--
-- Indices de la tabla `categoriaxentrada`
--
ALTER TABLE `categoriaxentrada`
  ADD PRIMARY KEY (`ID_CATEGORIAXENTRADA`),
  ADD KEY `FK_REFERENCE_7` (`ID_CATEGORIA`),
  ADD KEY `FK_REFERENCE_8` (`ID_ENTRADA`);
...
ALTER TABLE `comentarios`
  ...
  ADD KEY `FK_REFERENCE_3` (`ENTRADA_ID`),
...
ALTER TABLE `entradas`
  ...
  ADD KEY `FK_REFERENCE_2` (`ID_USUARIO`);
...
ALTER TABLE `megusta`
  ...
  ADD KEY `FK_REFERENCE_5` (`ENTRADA_ID`),
  ADD KEY `FK_REFERENCE_6` (`ID_USUARIO`);
...
--
-- AUTO_INCREMENT de la tabla `categoriaxentrada`
--
ALTER TABLE `categoriaxentrada`
  MODIFY `ID_CATEGORIAXENTRADA` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `comentarios`
--
ALTER TABLE `comentarios`
  MODIFY `ID_COMENTARIO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4613;
--
-- AUTO_INCREMENT de la tabla `entradas`
--
ALTER TABLE `entradas`
  MODIFY `ID_ENTRADA` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de la tabla `megusta`
--
ALTER TABLE `megusta`
  MODIFY `ID_MEGUSTA` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
--
