...
<body>
    ...
    <div class="pm-mobile-global-menu">
        <div class="pm-mobile-global-menu-logo">
            <a href="{{URL::route('index')}}">
                <img src="{{asset('img/logo-aguila-roja.png')}}" alt="Logo representativo Aguila Roja"></a>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6">
                        ...
                        <ul class="pm-sub-navigation">
                            ...
                            <li class="pm-search-btn-li"><a href="https://www.facebook.com/CafeAguilaRoja" rel="nofollow" class="pm-search-btn" target="_blank"
                                    id="social"><i class="fa fa-facebook"></i></a></li>
                            <li class="pm-search-btn-li">
                                <a href="http://www.twitter.com" rel="nofollow" class="pm-search-btn" target="_blank" id="social"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li class="pm-search-btn-li"><a href="https://plus.google.com/u/2/b/112747037083375313285/112747037083375313285/" rel="publisher"
                                    target="_blank" id="social" class="pm-search-btn"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="pm-header-logo-container">
                            ...
                            <a href="{{URL::route('index')}}">
                                <img id="logo-aguila-roja" src="{{asset('img/logo-aguila-roja.png')}}" class="img-responsive pm-header-logo" alt="Logo representativo Aguila Roja"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 pm-widget-footer">
                        ...
                        <ul>
                            ...
                            <li class="footer-logo-google"><a href="https://plus.google.com/u/2/b/112747037083375313285/112747037083375313285/" rel="publisher"
    ...
    <link href='http://fonts.googleapis.com/css?family=Cantata+One%7COpen+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic'
