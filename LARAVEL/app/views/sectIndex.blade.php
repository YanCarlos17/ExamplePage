    ...
    <div class="pm-pulse-container" id="pm-pulse-container">
        ...
        <div id="pm-slider" class="pm-slider" >
            ...
            <ul class="pm-slides-container" id="pm_slides_container">
                ...
                <li data-thumb="img/slider/slider-graninostickers-marzo-2017-mini.jpg" class="pmslide_1" ><img src="img/slider/slider-graninostickers-marzo-2017.jpg" alt="Aplicaci&oacute;n Graninostickers Aguila Roja" />
                    <div class="pm-holder botones-slider" >
                        <!--<div class="pm-caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                ...
                <div class="pm-menu-item-container">
                    ...
                    <div class="pm-menu-item-desc">
                        ...
                        <p class="pm-menu-item-excerpt">Verter en la licuadora el cafÃ© y la leche en polvo, batir por 30 segundos saborizar al gusto con una pozca de cocoa, vainilla o licor (opcional); Sirvalo y disfrÃºtelo inmediatamente. <br><a href="recetas-de-cafe/CAF&Eacute;-CAPUCCINO">Preparaci&oacute;n de Caf&eacute; Capuccino...</a></p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                ...
                <div class="pm-menu-item-container">
                    ...
                    <div class="pm-menu-item-desc">
                        ...
                        <h3>CAFÃ‰ MOKA<BR>INGREDIENTE (PARA 2 PERSONAS)</h3>

                        <p class="pm-menu-item-excerpt">Colocar el cafÃ© reciÃ©n preparado en cada taza. Licuar aparte la leche caliente (sin hervir) con el chocolate y la leche en polvo. Adicionar la mezcla sobre el cafÃ©; SÃ­rvalo decorado con las gotas de chocolate y disfrÃºtelo inmediatamente. <br><a href="recetas-de-cafe/CAF&Eacute;-MOKA">Preparaci&oacute;n de Caf&eacute; MOKA...</a></p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                ...
                <div class="pm-menu-item-container">
                    ...
                    <div class="pm-menu-item-desc">
                        ...
                        <h3>CAFÃ‰ MIX<BR>INGREDIENTES (PARA 2 PERSONAS)</h3>
