...
<div class="pm-pulse-container" id="pm-pulse-container">
    <div id="pm-slider" class="pm-slider">
        ...
        <ul class="pm-slides-container" id="pm_slides_container">
            <li data-thumb="img/slider/sliderGanarMama-min.jpg" class="pmslide_0">
                <img src="img/slider/sliderGanarMama.jpg" alt="Productos de Caf&eacute; Aguila Roja" />
            ...
            <li data-thumb="img/slider/slider-dia-de-la-madre-2017-mini.jpg" class="pmslide_0">
                ...
                <div class="pm-holder botones-slider">
                    <div class="pm-caption">
                        <!--class="pm-slide-btn animated" target="_blank" -->
...
<div class="container pm-containerPadding-top-90">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 pm-center pm-column-spacing">
            ...
            <p>Lo invitamos a innovar, crear y degustar utilizando nuestro exquisito cafÃ© Aguila Roja.</p>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 pm-center pm-column-spacing">
            ...
            <p>Descarga la aplicaciÃ³n del granito y envÃ­a emoticones a tus amigos.</p>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
            ...
            <div class="pm-menu-item-container">
                ...
                <div class="pm-menu-item-desc">
                    ...
                    <p class="pm-menu-item-excerpt">Verter en la licuadora el cafÃ© y la leche en polvo, batir por 30 segundos saborizar al gusto con una
                        pozca de cocoa, vainilla o licor (opcional); Sirvalo y disfrÃºtelo inmediatamente. <br><a href="recetas-de-cafe/CAF&Eacute;-CAPUCCINO">Preparaci&oacute;n de Caf&eacute; Capuccino...</a></p>
                </div>
            </div>
        </div>
        <!-- /.col-lg-4 -->
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
            <div class="pm-menu-item-container">
                ...
                <div class="pm-menu-item-desc">
                    ...
                    <p class="pm-menu-item-excerpt">Colocar el cafÃ© reciÃ©n preparado en cada taza. Licuar aparte la leche caliente (sin hervir) con el
                        chocolate y la leche en polvo. Adicionar la mezcla sobre el cafÃ©; SÃ­rvalo decorado con las gotas
                        de chocolate y disfrÃºtelo inmediatamente. <br><a href="recetas-de-cafe/CAF&Eacute;-MOKA">Preparaci&oacute;n de Caf&eacute; MOKA...</a></p>
                </div>
            </div>
        </div>
        <!-- /.col-lg-4 -->
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
            <div class="pm-menu-item-container">
                ...
                <div class="pm-menu-item-desc">
                    <h3>CAFÃ‰ MIX
                        <BR>INGREDIENTES (PARA 2 PERSONAS)</h3>
                    <p class="pm-menu-item-excerpt">Mezcle el ron, el jugo y el Caf&eacute; Aguila Roja y vierta en una coctelera con cubos de hielo. Aparte,
