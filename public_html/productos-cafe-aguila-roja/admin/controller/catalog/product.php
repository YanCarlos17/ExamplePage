...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['paisEan'] = $this->language->get('paisEan');
		$this->data['paisItf'] = $this->language->get('paisItf');
		...
		if (isset($this->request->post['paisEan'])) {
			$this->data['paisEan'] = $this->request->post['paisEan'];
		} elseif (!empty($product_info)) {
			$this->data['paisEan'] = $product_info['paisEan'];
		} else {
			$this->data['paisEan'] = '';
		}


		if (isset($this->request->post['paisItf'])) {
			$this->data['paisItf'] = $this->request->post['paisItf'];
		} elseif (!empty($product_info)) {
			$this->data['paisItf'] = $product_info['paisItf'];
		} else {
			$this->data['paisItf'] = '';
		}		
