    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              <td><span class="required">*</span> <!--<?php echo $entry_model; ?>-->ITF resto del pa&iacute;s</td>
		...
		<tr>
			<td>EAN resto del pais</td>
			<td><input type="text" name="paisEan" value="<?php echo $paisEan; ?>" /></td>
			</td>
		</tr>
		<tr>
			<td>ITF Bogot&aacute;</td>
			<td><input type="text" name="paisItf" value="<?php echo $paisItf; ?>" /></td>
			</td>
		</tr>		
