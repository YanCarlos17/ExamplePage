...
$http_type = "https:";} else {$http_type = "http:";} 
 ...
 ?><link href='<?php echo $http_type;?>//fonts.googleapis.com/css?family=Open+Sans:400,700' rel='stylesheet' type='text/css'>

 <link href='<?php echo $http_type;?>//fonts.googleapis.com/css?family=Lato:400,700' rel='stylesheet' type='text/css'>

  <link href='<?php echo $http_type;?>//fonts.googleapis.com/css?family=Oswald:400,700' rel='stylesheet' type='text/css'>
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/OPC040092/micss.css" />
...
<header id="header-container"><div id="transparencia"></div>
	...
	<div id="header">
		...
		<div class="header-right">  <!--megnor 'header-right' start -->
		   ...
		   <div class="welcome-links" style="margin: 23px 0 80px !important;"><!--EDITADO AÑADIDO STYLE PARA OCULTAR-->

				<div class="links" style="display:none;">						<!--EDITADO AÑADIDO STYLE PARA OCULTAR-->						
				...
				<div id="welcome" style="display:none;"><!--EDITADO AÑADIDO STYLE PARA OCULTAR-->
		...
		<div class="nav-responsive"><span>Menu</span><div class="expandable"></div></div>
		  ...
		  <ul class="main-navigation">
			<li><a href="http://cafeaguilaroja.com/">HOME</a></li>
		...
		<!-- EDITADO <div class="header_bottom">
...
<div class="header_content_bottom"></div>
