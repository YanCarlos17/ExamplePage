<div class="box">
	...
	<div class="title_block">
  		...
  		<div class="box-heading"><!--<?php echo $heading_title; ?>-->Productos Aguila Roja</div>
...
<!-- Megnor End-->	
	  ...
	  <div class="product-block-inner">
        ...
        <?php } ?>
			...
			<!-- EDITADO<div class="cart"><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button" /></div>-->
