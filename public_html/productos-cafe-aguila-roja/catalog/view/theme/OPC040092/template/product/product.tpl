...
<div id="content"><?php echo $content_top; ?> 
  ...
  <div class="breadcrumb" id="brd-crumbs"  >
    ...
    <div class="right">	  
		...
		<?php if( $model == '47702040047106'){ ?>
		
		<tr><td><span>C&oacute;digo del producto EAN 13: </span></td><td class="description-right">7702040005009</td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
		<tr><td><span>C&oacute;digo del producto EAN 13 Resto del Pa&iacute;s: </span></td><td class="description-right">7702040004132</td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
			
		<tr><td><span>C&oacute;digo del producto EAN 14 Bogot&aacute; - Cali: </span></td><td class="description-right">47702040000514</td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
		<tr><td><span>C&oacute;digo del producto EAN 14 Cali - Valle: </span></td><td class="description-right">47702040005205</td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
		<tr><td><span>C&oacute;digo del producto EAN 14 Resto del Pa&iacute;s: </span></td><td class="description-right">47702040047106</td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->

		<?php }else{ ?>	

		<tr><td><span>C&oacute;digo del producto EAN 13: </span></td><td class="description-right"><?php echo $ean; ?></td></tr><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
		<?php if($paisEan != null){?><tr><td><span>C&oacute;digo del producto EAN 13 Bogot&aacute;: </span></td><td class="description-right"><?php echo $paisEan; ?></td></tr><?php } ?><!-- MODIFICADO PARA MOSTRAR CODIGO EAN -->
	        <tr><td><span><!--<?php echo $text_model; ?>-->C&oacute;digo de reempaque EAN 14: </span></td><td class="description-right"><?php echo $model; ?></td></tr>
		<?php if($paisItf != null){?><tr><td><span>C&oacute;digo de reempaque EAN 14 Bogot&aacute;: </span></td><td class="description-right"><?php echo $paisItf; ?></td></tr><?php } ?>
        ...
        <?php } ?>
        	...
        	<!--<tr ><td><span><?php echo $text_stock; ?></span></td><td class="description-right"><?php echo $stock; ?></td></tr><!-- EDITADO STYLE DISPLAY NONE EN el tr -->
      ...
      <div class="price" style="display:none;"><?php echo $text_price; ?><!-- EDITADO STYLE DISPLAY NONE EN CLASE PRICE -->
  ...
  <div class="tags product-info-tags" style="display:none"><b><?php echo $text_tags; ?></b><!-- EDITADO STYLE DISPLAY NONE EN div -->
